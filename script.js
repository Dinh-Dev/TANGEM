...
function createHeart() {
  ...
  const size = 25 + Math.random() * 50; // tim lớn hơn
...
// Xuất hiện nhiều tim ban đầu
for (let i = 0; i < 200; i++) createHeart();
  ...
  setTimeout(()=>{
    ...
    function typeWriter() {
      if(index < text.length){
        ...
        // Hiển thị dòng cuối rực rỡ từ từ bất ngờ
        finalText.style.opacity = 1;
        finalText.style.animation = "finalAppear 5s ease-out forwards";
      }
    }
    typeWriter();
  }, 2500);
